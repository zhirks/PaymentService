...
public class Login_003_InvalidEmail1 extends TestBase {

	public Login_003_InvalidEmail1() {
		super();
	}
	...
	@Test
	public void verifyInvalidEmail1() {
		...
		String invalidEmail1 = data.getStringData("Login", 3, 0);
